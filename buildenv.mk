...
CONFIG_CONSUMER_DATA_GENERATOR := y
endif
endif
...
ifdef CONFIG_CONSUMER_DATA_GENERATOR
ifeq ($(CONFIG_CONSUMER_DATA_GENERATOR), y)
C_Files += $(ROOT_DIR)/framework/data_generator_consumer.c
C_Flags += -DPCD_CONFIG_CONSUMER_DATA_GENERATOR
endif
endif
