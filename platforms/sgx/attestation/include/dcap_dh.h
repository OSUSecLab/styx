...
/* As session initiator : Step.1 pcd_dh_dcap_init_session -->  Step.2 pcd_dh_dcap_initiator_proc_msg1 --> Step.3 pcd_dh_dcap_initiator_proc_msg3 */
/* As session responder :  Step.1 pcd_dh_dcap_init_session --> Step.2 pcd_dh_dcap_responder_gen_msg1 --> Step.3 pcd_dh_dcap_responder_proc_msg2*/
/* Any out of order calling will cause session establishment failure. */

/*Function name: pcd_dh_dcap_init_session
...
*/
sgx_status_t  pcd_dh_dcap_init_session(sgx_dh_session_role_t role,
                                        sgx_dh_session_t* session);

/*Function name: pcd_dh_dcap_responder_gen_msg1
** parameter description
...
*/
sgx_status_t  pcd_dh_dcap_responder_gen_msg1(pcd_dh_dcap_msg1_t* msg1,
                                              sgx_dh_session_t* dh_session);
/*Function name: pcd_dh_dcap_initiator_proc_msg1
** parameter description
...
/*Function name: pcd_dh_dcap_responder_proc_msg2
** parameter description
...
/*Function name: pcd_dh_dcap_initiator_proc_msg3
** parameter description
